...
# ══════════════════════════════════════════════════════════════
# STEP 6 — TULIS .ENV (CREDENTIALS)
# ══════════════════════════════════════════════════════════════
section "STEP 6/8 — SETUP .ENV (CREDENTIALS)"
...
# INTERNAL USE ONLY — JANGAN COMMIT / SHARE FILE INI
# ─────────────────────────────────────────────────────────────
...
chmod 600 "$ENV_PATH"
ok ".env ditulis & dikunci (permission 600): ${ENV_PATH}"

# Verifikasi semua key ada — kalau ada yang miss langsung stop
REQUIRED_KEYS=(
...
if [ "$ENV_OK" = false ]; then
    err "Ada key yang hilang di .env! Installer berhenti."
    err "Cek file: ${ENV_PATH}"
    exit 1
fi
