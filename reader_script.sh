...
IP_READER="${READER_COHERENT_IP}"
PASSWORD_READER="${READER_PASSWORD}"
SSH_READER="$USERNAME_READER@$IP_READER"

SUPPORT_SSH_PASS="${PARKEE_SSH_PASS}"
AGENT_SERVER_HOST="${AGENT_SERVER_HOST}"
AGENT_SSH_PORT_ALT="${AGENT_SSH_PORT_ALT}"
AGENT_DB_NAME="${AGENT_DB_NAME}"
AGENT_DB_SUFFIX="${AGENT_DB_SUFFIX}"
FTP_HOST="${FTP_HOST}"
FTP_USERNAME="${FTP_USERNAME}"
QIQO_PASSWORD="${QIQO_PASSWORD}"
QIQO_SALT="${QIQO_SALT}"
